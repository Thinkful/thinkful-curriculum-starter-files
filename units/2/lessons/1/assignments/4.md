...
First we can create a *function stub*: a function that is defined but does nothing. This will let us think about the inputs that we need in order to save a snippet. In a file called *snippets.py* try adding the following stub:
