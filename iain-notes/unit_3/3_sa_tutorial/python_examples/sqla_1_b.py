"""sqla_1.py - a complete sqalalchemy script"""
...
class Species(Base):
    ...
    #breeds = relationship("Breed", backref='species', order_by=name)
    #breeds = relationship("Breed", backref=backref('species', order_by=Breed.name) )
